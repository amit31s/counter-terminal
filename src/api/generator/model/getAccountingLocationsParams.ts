...
import type { AccountingLocationTypeParamParameter } from './accountingLocationTypeParamParameter';

export type GetAccountingLocationsParams = {
/**
 * Filter by status (e.g. "active")
 */
status?: StatusParamParameter;
/**
 * Filter by accounting location type (e.g. "safe")
 */
accountingLocationType?: AccountingLocationTypeParamParameter;
};
